...
var GameRoomPrepareUI = UIBase.extend({
	...
	initUI:function(){
		...
		var share_title = '房間號【' + player.curGameRoom.roomID.toString() + '】';
		var share_desc = '我在[推倒胡]开了' + player.curGameRoom.maxRound.toString() + '局，' + player.curGameRoom.luckyTileNum.toString() + '个码的房间，快来一起玩吧';
