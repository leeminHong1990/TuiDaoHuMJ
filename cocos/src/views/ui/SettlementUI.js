...
var SettlementUI = UIBase.extend({
    ...
    show_by_info: function (roundRoomInfo, confirm_btn_func) {
        ...
        this.show(function () {
            ...
            // self.show_win_img(roundRoomInfo["result"][0]);
    ...
    update_player_hand_tiles: function (serverSitNum, tileList) {
        ...
        cc.log("upTilesList :" + player.curGameRoom.upTilesList[serverSitNum].length);
        cc.log("" + ((player.curGameRoom.upTilesList[serverSitNum].length * 180) + 280));
    ...
    update_player_info: function (serverSitNum) {
        ...
        // var frame_img = ccui.helper.seekWidgetByName(cur_player_info_panel, "item_avatar_img");
    ...
    update_score: function (serverSitNum, score) {
        ...
        cc.log(this.player_tiles_panels);
